...
const SKILL_GROUPS = {
  Frontend: {
    ...
    items: [
      { name: 'React', where: 'Every client platform + this site' },
      { name: 'TypeScript', where: 'Neema Foundation + Culture SZN' },
      { name: 'Vite', where: 'Every client platform + this site' },
      { name: 'Tailwind CSS', where: 'Every client platform + this site' },
      { name: 'React Query', where: 'Raslipwani + Neema Foundation' },
      { name: 'Framer Motion', where: 'Every client platform + this site' },
      { name: 'React Hook Form + Zod', where: 'Neema Foundation + this site' },
      { name: 'TipTap', where: "Neema Foundation's CMS editor" },
      { name: 'MDX', where: "Culture SZN's journal" },
    ],
  },
  'Backend & Data': {
    description: 'Where the data lives and who is allowed to touch it.',
    items: [
      { name: 'PostgreSQL', where: 'Raslipwani + Neema Foundation' },
      { name: 'Supabase', where: 'Raslipwani, Neema Foundation + this site' },
      { name: 'Row-Level Security', where: 'Raslipwani + Neema Foundation' },
      { name: 'Supabase Auth', where: 'Raslipwani + Neema Foundation' },
      { name: 'Resend', where: 'Raslipwani, Culture SZN + this site' },
  ...
  'Testing & Tooling': {
    ...
    items: [
      { name: 'Vitest', where: 'Raslipwani, Culture SZN + this site' },
      { name: 'React Testing Library', where: 'Raslipwani, Culture SZN + this site' },
      { name: 'Playwright', where: 'Screenshot capture for this site' },
      { name: 'ESLint', where: 'Every project' },
      { name: 'Sentry', where: 'This site' },
      { name: 'Vercel', where: 'Every client platform' },
      { name: 'GitHub Actions', where: 'Culture SZN + this site' },
    ],
  },
  Engineering: {
