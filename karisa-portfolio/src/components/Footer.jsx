        ...
        <div className="mt-12 pt-6 border-t border-ink-800 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-ink-400 hidden sm:inline">Crafted with</span>
              <div className="text-signal">
            ...
            <a 
              href="#" 
              onClick={scrollToTop}
              className="text-ink-400 hover:text-signal transition-colors flex items-center gap-1 text-sm"
            >
              Back to top
