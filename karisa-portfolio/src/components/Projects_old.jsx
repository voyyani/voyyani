...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      id: 2,
      title: "The Bike Collector",
      tagline: "E-commerce Cycling Platform",
      description: "Full-featured e-commerce platform for cycling enthusiasts, with inventory management, secure payment processing, and customer relationship tools.",
      technologies: ["React", "Node.js", "Stripe", "MongoDB", "Express"],
      metrics: [
        { icon: "🛍️", label: "Products", value: "500+" },
        { icon: "💳", label: "Payments", value: "Secure" },
        { icon: "⭐", label: "Rating", value: "4.8/5" }
      ],
      category: "E-Commerce",
      challenge: "Streamlining checkout process while maintaining security",
      solution: "Integrated Stripe with optimized checkout flow reducing cart abandonment by 45%",
      features: [
    ...
    },
    {
      id: 3,
      title: "Portfolio v2",
      tagline: "Interactive Personal Brand",
      description: "A modern, performance-optimized portfolio showcasing engineering and development expertise with smooth animations and world-class UX.",
      technologies: ["React", "Vite", "Framer Motion", "Tailwind CSS", "EmailJS"],
      metrics: [
        { icon: "🎨", label: "Design", value: "Premium" },
        { icon: "⚡", label: "Lighthouse", value: "98" },
        { icon: "📱", label: "Responsive", value: "100%" }
      ],
      category: "Portfolio",
      challenge: "Creating an engaging experience that stands out",
      solution: "Combined African-inspired design with cutting-edge animations and micro-interactions",
      features: [
