      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <AnimatePresence>
          <motion.div
            ...
            className="bg-gradient-to-br from-[#0a1929]/90 to-[#061220]/90 backdrop-blur-sm border border-[#005792]/20 rounded-2xl p-5 md:p-8 overflow-hidden"
          >
            ...
            <motion.h3 
              ...
              className="text-lg md:text-xl text-center mb-6 md:mb-10 text-gray-200 font-medium"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              {principles.map((principle, index) => (
                <motion.div
                  ...
                  className="bg-[#061220]/80 p-4 md:p-5 rounded-xl border border-[#005792]/20 hover:border-[#D4A017]/50 transition-all"
                >
                  <div className="flex items-start mb-3">
                    <div className="text-2xl md:text-3xl mr-3">{principle.icon}</div>
                    <div>
                      <h4 className="text-base md:text-lg font-bold text-gray-100">{principle.title}</h4>
                      <div className="w-10 h-0.5 bg-[#D4A017] mt-1 mb-2"></div>
                    </div>
                  </div>
                  <p className="text-gray-400 text-sm pl-11">{principle.description}</p>
                </motion.div>
              ))}
            </div>
            ...
            <motion.div
              ...
              className="mt-8 md:mt-10 p-4 md:p-5 border-l-4 border-[#D4A017] bg-[#061220]/50 rounded-r-xl"
            >
