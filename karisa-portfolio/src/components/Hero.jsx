...
const Hero = () => {
  ...
  return (
    <section 
      className="min-h-[90vh] flex flex-col items-center justify-center relative overflow-hidden px-4 py-12"
    ...
    >
      ...
      <div className="text-center relative z-10 max-w-4xl">
        ...
        <div className="h-20 md:h-24 flex flex-col md:flex-row items-center justify-center mb-6">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5, delay: 0.5 }}
            className="text-2xl md:text-3xl mx-2 text-[#D4A017] hidden md:block"
          >
            →
          </motion.div>
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className={`text-xl md:text-2xl px-6 py-3 rounded-lg ${
        ...
        <motion.p
          ...
          className="text-lg md:text-xl mb-8 md:mb-12 max-w-2xl mx-auto text-gray-300"
        >
        ...
        >
          <a 
            href="#projects" 
            className="bg-gradient-to-r from-[#005792] to-[#004274] hover:from-[#004274] hover:to-[#003258] text-white px-6 py-3 md:px-8 md:py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg"
          >
          ...
          <a 
            href="#contact" 
            className="border-2 border-[#D4A017] text-[#D4A017] hover:bg-[#D4A017]/10 px-6 py-3 md:px-8 md:py-3 rounded-lg font-medium transition-all duration-300 flex items-center gap-2 shadow-lg"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <motion.div 
        className="absolute bottom-8 left-0 right-0 flex justify-center gap-4 md:gap-6"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
